...
#     latest_blogs = Blog.objects.order_by("-created_at")[:8]
#     return render(request, "blog/index.html", {"latest_blogs": latest_blogs})
...
#     # comments = Comment.objects.filter(blog=blog, parent_comment__isnull=True)
#     # organized_comments = []
...
#     return render(
#         request, "blog/create-post.html", {"blog_post": blog_post, "update": True}
#     )
...
#     return render(
#         request, "blog/search-results.html", {"blog_posts": blogs, "query": query}
#     )
