# Generated by Django 5.0 on 2024-03-21 17:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('position', models.CharField(choices=[('employee', 'Employee'), ('seller', 'Seller'), ('store_manager', 'Store Manager'), ('assistant_manager', 'Assistant Manager'), ('cashier', 'Cashier')], default='employee', max_length=200)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fruit_image', models.ImageField(default='images/default_fruit.jpg', upload_to='images/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fruit', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='fruit_shop_app.fruit')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('supplier_product_image', models.ImageField(default='images/default_can.jpg', upload_to='images/')),
                ('supply_price', models.FloatField(default=0.0)),
                ('last_supply_date', models.DateField()),
                ('quantity_supplied', models.IntegerField(default=0)),
                ('fruit', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='fruit_shop_app.fruit')),
