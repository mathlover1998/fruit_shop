# Generated by Django 5.0 on 2024-05-20 01:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('expiry_date', models.DateTimeField(default=datetime.datetime(2024, 6, 19, 1, 6, 55, 996194, tzinfo=datetime.timezone.utc))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('applies_to', models.CharField(choices=[('all_products', 'All Products'), ('category', 'Category'), ('specific_products', 'Specific Products'), ('brand', 'Brand')], default='all_products', max_length=20)),
                ...
                ('products', models.ManyToManyField(blank=True, related_name='discounts', to='fruit_shop_app.product')),
            ],
            options={
