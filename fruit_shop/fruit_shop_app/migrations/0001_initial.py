# Generated by Django 5.0 on 2024-04-15 06:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('discount_type', models.CharField(choices=[('percentage', 'Percentage'), ('fixed_discount', 'Fixed Discount')], default='percentage')),
                ('amount_of_use', models.IntegerField(default=1, validators=[django.core.validators.MinValueValidator(1)])),
                ...
                ('max_value_discount', models.FloatField(default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(default='images/default-avatar.png', upload_to='images/user_images')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('position', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='fruit_shop_app.position')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_method', models.CharField(choices=[('cash', 'Cash'), ('momo', 'Momo')])),
