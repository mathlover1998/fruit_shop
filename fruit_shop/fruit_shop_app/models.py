...
class User(AbstractUser):
    ...
    gender = models.CharField(max_length=20,choices=GENDER,default='other',null=False)
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=['first_name', 'middle_name','last_name'], name='full_name')
        ]
class Employee(models.Model):
    ...
    position = models.CharField(max_length=200,choices=POSITION,default='employee',null=False)
...
class Discount(models.Model):
    ...
    discount_percentage = models.IntegerField(validators=[MinValueValidator(0), MaxValueValidator(100)],null=False)
...
class Fruit(models.Model):
    ...
    fruit_image = models.ImageField(upload_to='images/',default='images/default_fruit.jpg')
...
class SupplierProduct(models.Model):
    ...
    supplier_product_image = models.ImageField(upload_to='images/',default='images/default_can.jpg')
